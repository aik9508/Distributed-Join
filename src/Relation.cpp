...
Relation::Relation(int arity, string filename) : arity(arity)
{
    getData(filename);
    getPtrData();
}

Relation::Relation(int arity, vector<vector<int> > &data) : arity(arity), data(data)
{
    getPtrData();
}
...
Relation Relation::join(Relation &r1, Relation &r2, int *permu1, int *permu2, int nj, bool asc)
{
...
int Relation::joinCompare(vector<int> *v1, vector<int> *v2, int *permu1, int *permu2, int nj)
{
...
//     // cout << d << endl;
//     Relation r1(2, "../data/data1.txt");
//     Relation r2(2, "../data/data2.txt");
//     int permu1[] = {1, 0};
//     int permu2[] = {0, 1};
//     int nj = 1;
